...
client.ayarlar = {
  "prefix": "!", //prefix
  "oauthSecret": "mGAEF4h-97xP4WsNt7KrjF3jWfjdlXi5", //bot secreti
	"callbackURL": "https://difficult-feather-mulberry.glitch.me/callback", //benim sitenin urlsini kendin ile değiş "/callback" kalacak!
	"kayıt": "869668075836936202", //onaylandı, reddedildi, başvuru yapıldı falan kayıtların gideceği kanalın ID'ini yazacaksın
  "renk": "BLUE" //embedların rengini burdan alıo can sıkıntısdna yapılmış bişe falan fln
};



client.yetkililer = ['793589155367354388'] //tüm yetkililerin ıdleri gelcek array
client.webyetkililer = ['793589155367354388'] //web yetkililerin ıdleri gelcek array
client.sunucuyetkililer = ['793589155367354388'] //sunucu yetkililerin ıdleri gelcek array
...
client.on("message", async message => {
    ...
    if (cmd.conf.permLevel === 'ozel') { //o komutu web yetkilileri kullanabsiln sadece diye yaptıgım bişe 
      ...
      var arr = [x.owner.id, '793589155367354388']
...
client.login(process.env.TOKEN) //tokeni yaz işte

process.env = {}
process.env.TOKEN = "ODE5NTg0MTY0MjI2NDAwMjk2.YEovOw.CVcfYNxeBDOdFLNbt-e-lp7acX0";